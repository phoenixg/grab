...
$pages = file('id006.txt', FILE_IGNORE_NEW_LINES);
...
foreach ($pages as $k => $page) {
  ...
  if(is_null($html->find("table", 3) )) {
    ...
    // 之前的代码这里居然把采集变量写重复了！！！！！！！！！！！！
    fwrite($handle,  $mentor_sex.'|'.$mentor_nationality.'|'.$mentor_birthday.'|'.$mentor_school.'|'.$mentor_academic.'|'.$mentor_major.'|'.
                                  $mentor_identity.'|'.$mentor_teachable.'|'.$mentor_selfIntro.'|'.$mentor_certificate.'|'.$mentor_teachSchool.'|'.
